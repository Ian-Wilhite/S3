...
int main() {
    ...
    int a = -1, b = 2, c = 0, d = -2, e = -1;
    cout << (a & 0x80000000) << std::endl;
    cout << (b & 0x80000000) << std::endl;
    cout << (c & 0x80000000) << std::endl;
    cout << (d & 0x80000000) << std::endl;
    cout << (e & 0x80000000) << std::endl;

    

    /*
    cout << "Welcome to the Debugging Homework for CS 120!" << endl;
